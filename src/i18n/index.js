...
const dict = {
  zh: {
    ...
    waitCooldown: '稍后再试',
    offScale: '爆表',
    offScaleHint: '污染已超国标刻度',
    quotaTitle: '今日额度用尽',
    quotaHint: '服务休息到明天 · 额度 {n}/日',
    quotaFoot: '明天再来看空气',
    splashHint: '读取空气…',
    splashStart: '准备中…',
    splashLocation: '定位中…',
  ...
  en: {
    ...
    offScale: 'off-scale',
    offScaleHint: 'beyond the national scale',
    quotaTitle: 'daily limit reached',
    quotaHint: 'rest until tomorrow · {n}/day',
    quotaFoot: 'come back tomorrow',
    splashHint: 'reading the air…',
    splashStart: 'starting…',
    splashLocation: 'locating…',
    splashAir: 'reading air…',
